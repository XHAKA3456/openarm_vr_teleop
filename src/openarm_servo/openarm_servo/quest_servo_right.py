#!/usr/bin/env python3
"""
Quest VR Teleoperation for OpenArm Right Arm
...
class QuestServoRight(Node):
    def __init__(self, host='0.0.0.0', port=5454):
        super().__init__('quest_servo_right')
    ...
    def publish_gripper_command(self):
        ...
        trigger = right.get('trigger', 0.0)

        # Only send command if trigger changed significantly (>1% change or first time)
